        ...
        try:
            ...
            return WrappedPreTrainedTokenizer(
                AutoTokenizer.from_pretrained(
                    pretrained_model_name_or_path, local_files_only=True, trust_remote_code=True, use_fast=True, **kwargs
                )
            )
        except OSError:
            ...
            return WrappedPreTrainedTokenizer(
                AutoTokenizer.from_pretrained(
                    pretrained_model_name_or_path, local_files_only=False, trust_remote_code=True, use_fast=True, **kwargs
                )
            )
